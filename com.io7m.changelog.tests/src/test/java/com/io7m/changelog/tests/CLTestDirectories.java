...
public final class CLTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(CLTestDirectories.class);

  private CLTestDirectories()
  {
  ...
  {
    final var path =
      Path.of(System.getProperty("java.io.tmpdir")).resolve("changelog");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/changelog/tests/%s", name);
