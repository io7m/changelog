...
import com.io7m.changelog.tests.xml.CRoundTripContract;
...
public final class CRoundTripTest extends CRoundTripContract
{
  @Override
  ...
  @Override
  protected CXMLChangelogWriterProviderType writers()
  {
    return new CXMLChangelogWriters();
  }
}
