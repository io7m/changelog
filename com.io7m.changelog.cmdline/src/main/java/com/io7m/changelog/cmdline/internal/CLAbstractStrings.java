...
/**
 * An abstract implementation of the {@link CLStringsType} interface.
 */

public abstract class CLAbstractStrings implements CLStringsType
{
  private final ResourceBundle resources;

  protected CLAbstractStrings(
